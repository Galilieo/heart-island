...
**Files:**
- Modify: `docs/04-数据库设计说明书.md`
- Modify: `docs/05-接口设计说明书.md`
- Modify: `docs/06-详细设计说明书.md`
- Modify: `docs/08-测试说明书.md`
...
```bash
git add docs/04-数据库设计说明书.md docs/05-接口设计说明书.md docs/06-详细设计说明书.md docs/08-测试说明书.md
